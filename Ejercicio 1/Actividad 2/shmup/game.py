...
class Game:
    ...
    def __init__(self):
        ...
        self.__label = Label(self.__screen.get_size(), self.__font)
    ...
    def __update(self, delta):
        self.__label.update(delta, self.__screen.get_size())

    def __render(self):
        self.__screen.fill(Config.background_color)
        self.__label.render(self.__screen)
        self.__fps_stats.render_stats(self.__screen)
        pygame.display.update()

    def __quit(self):
        self.__label.release()
        pygame.quit()
